...
urlpatterns = [
    ...
    path("api/research/agent/edit/<uuid:doc_id>/", agent_views.agent_edit, name="research_agent_edit"),
    path("api/research/agent/edit/apply/<uuid:doc_id>/", agent_views.agent_apply_edit, name="research_agent_apply_edit"),
