...
AGENT_MAX_OUTPUT_TOKENS = int(os.environ.get("OPENAI_AGENT_MAX_OUTPUT_TOKENS", "5000"))
...
AGENT_FINALIZATION_MAX_OUTPUT_TOKENS = int(
    os.environ.get("OPENAI_AGENT_FINALIZATION_MAX_OUTPUT_TOKENS", "3000")
)
...
_JSON_REPAIR_MAX_OUTPUT_TOKENS = int(
    os.environ.get("OPENAI_AGENT_JSON_REPAIR_MAX_OUTPUT_TOKENS", "2500")
)
_CONTINUE_RESPONSE_MAX_OUTPUT_TOKENS = int(
    os.environ.get("OPENAI_AGENT_CONTINUE_MAX_OUTPUT_TOKENS", "3000")
)
